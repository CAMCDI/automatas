...
class forListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by forParser#print.
    def enterPrint(self, ctx:forParser.PrintContext):
        pass

    # Exit a parse tree produced by forParser#print.
    def exitPrint(self, ctx:forParser.PrintContext):
        pass
